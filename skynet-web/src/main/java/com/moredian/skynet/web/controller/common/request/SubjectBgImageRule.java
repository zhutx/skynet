...
public class SubjectBgImageRule {
	
	private boolean sizeLimit = true; // 是否限制最小规格
	private Integer minWidth = 800; // 最小宽度像素
	private Integer minHeight = 600; // 最小高度像素
	private Integer maxWidth = 1280; // 最大宽度像素
	private Integer maxHeight = 800; // 最打高度像素
	private boolean ratioLimit = false; // 是否限制宽高比
	private Float minRatio = 1.0F; // 最小宽高比
	private Float maxRatio = 2.0F; // 最大宽高比
