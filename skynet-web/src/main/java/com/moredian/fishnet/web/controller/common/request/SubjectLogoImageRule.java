...
public class SubjectLogoImageRule {
	
	private boolean sizeLimit = true; // 是否限制最小规格
	private Integer minWidth = 80; // 最小宽度像素
	private Integer minHeight = 80; // 最小高度像素
	private Integer maxWidth = 200; // 最大宽度像素
	private Integer maxHeight = 200; // 最打高度像素
