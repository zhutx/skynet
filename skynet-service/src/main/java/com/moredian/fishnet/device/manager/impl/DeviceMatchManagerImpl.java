...
import com.moredian.fishnet.device.convertor.DeviceMatchConvertor;
...
import com.moredian.fishnet.device.mapper.DeviceMatchMapper;
...
public class DeviceMatchManagerImpl implements DeviceMatchManager {
	...
	public boolean matchDevice(DeviceMatchRequest request) {
		...
		Long id = idgeneratorService.getNextIdByTypeName("com.xier.fishnet.device.DeviceMatch").getData();
	...
	public boolean bindCameraWithDevice(Long orgId,Long cameraId, Long deviceId) {
		...
		Long id = idgeneratorService.getNextIdByTypeName("com.moredian.fishnet.device.DeviceMatch").getData();
		deviceMatch.setDeviceMatchId(id);
