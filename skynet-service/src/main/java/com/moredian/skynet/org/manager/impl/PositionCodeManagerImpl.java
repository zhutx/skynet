...
import com.moredian.skynet.org.mapper.ObjectSeedMapper;
import com.moredian.skynet.org.mapper.OrgMapper;
import com.moredian.skynet.org.mapper.PositionMapper;
import com.moredian.skynet.org.mapper.PositionSeedMapper;
...
public class PositionCodeManagerImpl implements PositionCodeManager {
    ...
    private Integer getNextOrgCode(Org org) {
        ...
        if(seed == null){
            ...
            Long id = idgeneratorService.getNextIdByTypeName("com.moredian.skynet.org.ObjectSeed").getData();
            seed.setSeedId(id);
    ...
    private String genPositionCodeBody(Position position) {
        ...
        if(seed == null){
            ...
            Long id = idgeneratorService.getNextIdByTypeName("com.moredian.skynet.org.PositionSeed").getData();
