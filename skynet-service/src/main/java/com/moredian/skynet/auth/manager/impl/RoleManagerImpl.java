...
import com.moredian.skynet.auth.domain.RolePerm;
...
import com.moredian.skynet.auth.mapper.RoleMapper;
...
public class RoleManagerImpl implements RoleManager {
	...
	private void updateRolePerm(Long roleId, List<Long> newPermIds){
		...
		for(Long permId : newPermIds) {
			...
			Long id = idgeneratorService.getNextIdByTypeName("com.moredian.skynet.auth.RolePerm").getData();
