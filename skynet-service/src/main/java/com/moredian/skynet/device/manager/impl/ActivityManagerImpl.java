...
import com.moredian.skynet.device.constant.HiveConst;
import com.moredian.skynet.device.constant.HiveMessage;
import com.moredian.skynet.device.constant.ModuleType;
import com.moredian.skynet.device.constant.StatusCode;
import com.moredian.skynet.device.domain.ActiveEquipmentInfo;
...
import com.moredian.skynet.device.enums.ActivationStatus;
import com.moredian.skynet.device.enums.DeviceAction;
import com.moredian.skynet.device.enums.HiveErrorCode;
import com.moredian.skynet.device.manager.ActivityManager;
import com.moredian.skynet.device.manager.BaseDeviceManager;
import com.moredian.skynet.device.manager.DeviceManager;
import com.moredian.skynet.device.manager.InventoryDeviceManager;
import com.moredian.skynet.device.request.ActivateDeviceRequest;
import com.moredian.skynet.device.request.ActivateInfoRequest;
import com.moredian.skynet.device.request.ActivationCodeRequest;
import com.moredian.skynet.device.request.BindDeviceRequest;
import com.moredian.skynet.device.request.DeviceAddRequest;
import com.moredian.skynet.device.request.DeviceUpdateRequest;
import com.moredian.skynet.device.request.GenerateQrCodeRequest;
import com.moredian.skynet.device.request.GetActivityStatusRequest;
import com.moredian.skynet.device.request.PerfectInfoRequest;
import com.moredian.skynet.device.request.ScanQrCodeRequest;
import com.moredian.skynet.device.request.UpdateQrCodeStatusRequest;
import com.moredian.skynet.device.response.ActivateDeviceResponse;
import com.moredian.skynet.device.response.BindDeviceResponse;
import com.moredian.skynet.device.response.GenerateQrCodeResponse;
import com.moredian.skynet.device.response.GetActivityStatusResponse;
import com.moredian.skynet.device.response.PerfectInfoResponse;
import com.moredian.skynet.device.response.ScanQrCodeResponse;
import com.moredian.skynet.device.response.UpdateQrCodeStatusResponse;
import com.moredian.skynet.device.utils.Coder;
...
//        Long id = idgeneratorService.getNextIdByTypeName("com.moredian.skynet.device.domain.BaseDevice").getData();
//        baseDevice.setId(id);
