...
public class DeviceGroupRelationServiceImpl implements DeviceGroupRelationService {
	...
	private List<GroupInfo> groupInfoListToGroupInfoList(List<com.moredian.skynet.org.model.GroupInfo> groupInfoList) {
	...
	public List<GroupInfo> findGroupByDeviceId(Long orgId, Long deviceId) {
		...
		List<com.moredian.skynet.org.model.GroupInfo> groupInfoList = groupService.findGroupByIds(orgId, groupIdList);
