...
public class DingUserSyncRequest implements Serializable {

	private static final long serialVersionUID = -6095757801651697424L;
	
	private Long orgId; // required
	private String dingUserId; // required
