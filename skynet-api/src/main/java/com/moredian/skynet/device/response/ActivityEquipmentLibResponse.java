 ...
 */
public class ActivityEquipmentLibResponse {
    ...
    public byte[] getAccessKeySecret() {
        return accessKeySecret;
    }

    public void setAccessKeySecret(byte[] accessKeySecret) {
