package com.moredian.fishnet.member.utils;
...
public class IDValidator {
	...
	public static void main(String[] args) {
		...
		//验证身份证是否有效
		//System.out.println(isValid("330381198610141415"));
		
		IDValidator idValidator = new IDValidator();
		//生成18位身份证号
		System.out.println(idValidator.makeID(false));

		/*//分析详细信息
		System.out.println(validator.getInfo("330381198610141415"));
